...
namespace BAL.Services.EmployeeOperations.Employee_AppointmentStatusService
{
    ...
    {
        public async Task<DataTable> GetEmployee_AppointmentStatus(EmployeePromotionOptionValues_DTO promotionOptionValues)
        {
            try
            {
                OpenContext();
                ...
                query += " and apm.appointment_status_name = 'Probation' order by esd.updated_on desc ";
